...
- Inline ESM-only dependencies into the CommonJS build so the editor keeps loading in CommonJS environments (ts-node, Jest, Node < 20.19) as it adopts modern ESM-only packages such as `rbush` v4. ([#9050](https://github.com/tldraw/tldraw/pull/9050))
